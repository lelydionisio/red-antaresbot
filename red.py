...
def initialize(bot_class=Bot, formatter_class=Formatter):
    ...
    async def on_ready():
        ...
        print(str(bot.user))
        print("\nConectado em:")
        print("{} servidores".format(servers))
        ...
        if bot.settings.token and not bot.settings.self_bot:
            print("\nUse essa URL para chamar o bot para o servidor")
        ...
        print("Tenha certeza que seu bot esta atualizado, use a opcao "
              "'update' no launcher")
    ...
    async def on_command_error(error, ctx):
        ...
        if isinstance(error, commands.MissingRequiredArgument):
            ...
            if is_help_cmd and is_forbidden and error.original.text == no_dms:
                msg = ("Nao consigo enviar mensagem de ajuda para voce"
                       " voce pode ter me bloqueado ou desativado as mensagem diretas.")
            ...
            await bot.send_message(channel, "Esse comando nao esta "
                                            "disponivel em DM")
        elif isinstance(error, commands.CommandOnCooldown):
            await bot.send_message(channel, "Esse comando esta em cooldown "
